...
PauseMenu createPauseMenu(ALLEGRO_FONT * font) {
	PauseMenu menu;
	menu.ContinuePlaybutton =  newButton((SCREEN_WIDTH / 2)-100, (SCREEN_HEIGHT / 2)-50, "Continuar", font);;
	menu.retriviedbutton = newButton((SCREEN_WIDTH / 2)-100, (SCREEN_HEIGHT / 2), "Tela Inicial", font);
	menu.exitButton = newButton((SCREEN_WIDTH / 2)-100, (SCREEN_HEIGHT / 2) + 50, "Sair do Jogo", font);;
	return menu;
}
